...
=====================
VEHICLE FORM NOTEBOOK
=====================

It's only purpose is to serve as base for other modules that need
additional page on vehicle form
...
5.  Search For *Notebook on vehicle form*
...
fleet_vehicle_notebook%0Aversion:%20
